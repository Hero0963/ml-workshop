...
window.__e2e = {
  ...
  async setSize(n) {
    // Since 2026-09-19 the editor has one size choice shared by Generate and Blank grid.
    document.querySelector(`input[type=radio][value="${n}"]`).click();
    await this.sleep(60);
    [...document.querySelectorAll('button')].find(b => b.textContent.trim() === 'Blank grid').click();
