...
CONFIG: Dict[str, any] = {
    ...
    "DATASET_PATH": "D:/it_project/github_sync/ml-workshop/thread-the-grid/datasets/rl_datasets/rl_dataset_2025-10-12_092521/puzzles.pkl",
...
def main():
    ...
    base_model_dir = PROJECT_ROOT / "thread-the-grid"
