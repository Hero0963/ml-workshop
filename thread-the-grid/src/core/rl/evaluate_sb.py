...
def run_evaluation(
    ...
    log_dir = PROJECT_ROOT / "thread-the-grid" / "logs"
    ...
    if use_training_puzzle:
        dataset_path = Path(
            "D:/it_project/github_sync/ml-workshop/thread-the-grid/datasets/rl_datasets/rl_dataset_2025-10-12_092521/puzzles.pkl"
        )
...
if __name__ == "__main__":
    ...
    default_model_path = (
        PROJECT_ROOT / "thread-the-grid" / "models" / "dqn_sb_cnn_single.zip"
    )
    parser.add_argument(
        "--model_path",
        type=str,
