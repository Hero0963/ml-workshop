...
from src.app.routers import echo, puzzle, solver, vision
from src.ui.gradio_app import demo as gradio_app

# Create FastAPI instance
app = FastAPI(
    title="Thread the Grid API",
    description="Generate, read and solve grid path puzzles, with a Gradio UI and a Svelte editor.",
    version="2.0.0",
)
...
def read_root():
    return {
        "message": "Welcome to the Thread the Grid API. Visit /docs for API documentation, /ui for the Gradio interface, or /svelte-ui for the advanced puzzle editor."
    }
