# src/core/vl_models/experiment_minicpm_structured.py
# This file is a test for the openbmb/minicpm-o2.6 model.
...
def run_structured_vision_test(image_path: Path):
    ...
    try:
        # 2. Hardcode model name for this specific test
